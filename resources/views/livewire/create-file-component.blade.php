        ...
        <form id="frm" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select wire:model.defer="frm.series_id" name="series_id" id="series_id" class="form-control form-control-sm">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" wire:model.defer="frm.title_of_content" name="title_of_content" id="title_of_content" class="form-control form-control-sm">
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="select2-purple">
                        <select class="form-control form-control-sm select2" wire:model.defer="frm.channels[]" name="channels[]" id="channels" multiple>
                ...
                <div class="form-group col-md-3" id="segments">
                    ...
                    <input class="form-control form-control-sm" type="number" wire:model.defer="frm.segments" name="segment" id="segment">
